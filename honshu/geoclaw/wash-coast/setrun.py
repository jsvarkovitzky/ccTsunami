...
#------------------------------
    ...
    clawdata.inratx = [4,6,4,10,15]  ##
    clawdata.inraty = [4,6,4,10,15]  ##
    clawdata.inratt = [5, 2, 1, 2, 9]  ##
    ...
    clawdata.checkpt_iousr = -1 # so times below are used:
    clawdata.tchk  = [32400.]   # when to checkpoint
...
#-------------------
    ...
    geodata.topofiles.append([-3, 1, 1, 0, 1.e10, \
                              honshu_dir + '/topo/PugetSound15sec126W122W47N49N.asc'])  ##

  # == setdtopo.data values ==
    geodata.dtopofiles = []
    # for moving topography, append lines of the form:  (<= 1 allowed for now!)
    #   [topotype, minlevel,maxlevel,fname]
    geodata.dtopofiles.append([1,2,3, honshu_dir + '/sources/honshu-ucsb3.tt1'])  ##
    ...
    geodata.regions.append([1, 3, 32400., 1e9, 220, 360, 44, 48])  ##
    geodata.regions.append([3, 5, 32400., 1e9, 235.7,236.3,46,47.05])  ##
    #geodata.regions.append([4, 4, 33000., 1e9, 235.7,236.3,46,47.05])  ##
    ...
    # Toke Point:
    geodata.gauges.append([40910, 236.0333, 46.7067, 30000., 1.e10]) ##
