...
#-------------------
    ...
    geodata.dtopofiles.append([1,2,3,'honshu-ucsb.tt1'])
    ...
    geodata.regions.append([1, 4, 0., 4000., 138,146,34,45])
    geodata.regions.append([1, 4, 0., 3600., 138,146,39,45])
    geodata.regions.append([1, 4, 3600., 7200.,  142,148,40,44.5])
    geodata.regions.append([1, 4, 7200., 1.e9,  144,148,42,44.5])
    geodata.regions.append([4, 5, 2500., 1.e9,  145.4,145.9,43.1,43.4])

    # == setgauges.data values ==
    geodata.gauges = []
    # for gauges append lines of the form  [gaugeno, x, y, t1, t2]
    geodata.gauges.append([1, 145.57, 43.28, 3000., 1.e10])
