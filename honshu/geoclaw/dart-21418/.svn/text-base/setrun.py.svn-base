...
#------------------------------
    ...
    clawdata.inratx = [3,5,4,2]
    clawdata.inraty = [3,5,4,2]
    clawdata.inratt = [3,5,4,2]
...
#-------------------
    ...
    geodata.topofiles.append([3, 1, 1, 0., 1.e10, \
                              '../../topo/etopo4min122E160E20N50N.asc'])
    geodata.topofiles.append([3, 1, 1, 0., 1.e10, \
                              '../../topo/etopo10min115E210E15N50N.asc'])
    ...
    geodata.regions.append([1, 5, 0., 900., 138,155,34,42])
    geodata.regions.append([1, 4, 900., 1e10, 142,152,36,40])
    geodata.regions.append([1, 5, 900., 1e10, 144,151,37,40])
    #geodata.regions.append([1, 4, 1440., 2700., 143,155,25,38])
    #geodata.regions.append([1, 4, 2700., 3600., 144,155,25,36])
    #geodata.regions.append([1, 4, 3600., 1.e9,  147,158,25,33])
