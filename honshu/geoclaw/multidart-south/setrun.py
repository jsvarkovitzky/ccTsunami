...
#------------------------------
    ...
    clawdata.inratx = [2,3,5,2]
    clawdata.inraty = [2,3,5,2]
    ...
    clawdata.tchk  = [clawdata.tfinal]   # when to checkpoint
...
#-------------------
    ...
    geodata.dtopofiles.append([1,5,5,'../../sources/honshu-ucsb3-1min.tt1'])
