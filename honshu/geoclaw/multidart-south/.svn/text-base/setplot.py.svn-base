...
#--------------------------
    ...
    def fixup(current_data):
        ...
        pylab.text(132,36.2,'Tokyo',color='w',fontsize=15)
        addgauges(current_data)
    ...
    def plot_dart(current_data):
        ...
        try:
            ...
            pass
        pylab.xlabel("Hours post-quake", fontsize=15)
        pylab.title("DART %s" % gaugeno, fontsize=18)
