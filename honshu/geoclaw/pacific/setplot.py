...
if 0:
    ...
    for gaugeno in [21413, 21418, 52402]:
...
#--------------------------
    ...
    plotfigure.kwargs = {'figsize':[16,8]}
    ...
    def fixup(current_data):
        ...
        #pylab.text(130,38,'Tokyo',color='w',fontsize=15)

        pylab.plot([140.8847],[38.2547],'ko',markersize=5)
        pylab.text(130,38,'Sendai',color='k',fontsize=15)

        pylab.plot([205],[19.7],'wo',markersize=4)
        #pylab.text(205,22,'Hawaii',color='k',fontsize=15)
        pylab.text(195,18,'Hawaii',color='k',fontsize=15)

        pylab.plot([235.81],[41.75],'wo',markersize=5)
        pylab.text(237.0,42,'Crescent City',color='w',fontsize=15)

        pylab.plot([237.67],[47.61],'wo',markersize=5)
        pylab.text(238.5,47.85,'Seattle',color='w',fontsize=15)
        addgauges(current_data)
        pylab.xlabel('degrees longitude', fontsize=15)
        pylab.ylabel('degrees latitude', fontsize=15)
    ...
    plotitem.imshow_cmin = -0.09
    plotitem.imshow_cmax = 0.09
    plotitem.add_colorbar = False
    plotitem.amr_gridlines_show = [0,0,0]
    plotitem.gridedges_show = 0
    plotitem.gridedges_color = 'y'
    ...
    plotaxes.title = 'Surface'
    plotaxes.scaled = True
    plotaxes.xlimits = [235.7,235.9]
    plotaxes.ylimits = [41.65,41.85]
